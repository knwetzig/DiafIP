...
// Dialog anzeigen
    $data = a_display([ // name,inhalt,rechte, optional-> $label,$tooltip,valString
                        new d_feld('bereich', null, RE_VIEW, 4015),
                        new d_feld('name', $myauth->getUsername(), RE_VIEW, 4016),
                        new d_feld('rname', $myauth->getAuthData('realname'), RE_VIEW, 517),
                        new d_feld('pwd', null, RE_VIEW, 4017),
                        new d_feld('pwd2', null, RE_VIEW, 4018),
                        new d_feld('submit', 'speichern', RE_VIEW, 4019)
                      ]);
