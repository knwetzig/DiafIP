 ...
 * $URL$
 *
 * ToDo: add und edit bearbeiten und mit Template abgleichen
 *
...
interface iPName extends iEntity {
    static function getNameList(); // Ermittelt die Person zum Aliasnamen
    function getPerson();

    function getName(); // Listet alle unbenutzten Aliasnamen (nicht Personen)
...
class PName extends Entity implements iPName {
    ...
    function add($status = null) {
         ...
         *
         * @param   bool (false Erstaufruf | true Verarbeitung nach Formular
         *               *********************************************************/
        global $myauth;
...
class Person extends PName implements iPerson {
    ...
    public function add($status = null) {
         ...
         *
         * @param  false Erstaufruf | true Verarbeitung nach Formular
         * @return void
         * @access public
         *               *********************************************************/
        global $myauth;
    ...
    public function edit($status = null) {
         ...
         *
         * @param      bool (false Formularanforderung | true Auswertung
         * @return     int
         *                  ***************************************************************/
        global $myauth, $marty;
        if (!isBit($myauth->getAuthData('rechte'), EDIT)) return 2;
